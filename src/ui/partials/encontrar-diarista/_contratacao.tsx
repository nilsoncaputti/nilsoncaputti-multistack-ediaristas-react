...
const Contratacao: React.FC = () => {
    ...
    return (
        <div>
            ...
            {step === 2 && (
                <PageTitle title={'Precisamos conhecer um pouco mais sobre você!'} 
                    subtitle={(
                        !hasLogin ? (
                            <span>
                    ...
                    <Paper sx={{p: 4}}>
                        ...
                        {step === 4 && (
                            <Box sx={{ textAlign: 'center' }}>
                                <Typography color={'secondary'} sx={{ fontSize: '82px' }}>
                                    <i className={'twf-check-circle'} />
                                </Typography>

                                <Typography color={'secondary'} sx={{ fontSize: '22px', pb: 3 }}>
                                    Pagamento realizado com sucesso!
                                </Typography>

                                <Typography 
                                    sx={{maxWidth: '410px', mb: 3, mx: 'auto',}}
                                    variant={'body2'}
                                    color={'textSecondary'}
                                >
                                ...
                                <Link href={'/diarias'} Component={Button} mui={{
                                        color: 'secondary',
                                        variant: 'contained',
                                    }}
                                >
