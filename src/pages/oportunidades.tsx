                        ...
                        <JobInformation>
                            <>
                                <div>
                                    Data:{' '}
                                    <strong>
                                        {TextFormatService.dateTime(oportunidadeSelecionada?.data_atendimento as string)}
                                    </strong>
                                </div>

                                <div>
                                    {TextFormatService.getAddress(oportunidadeSelecionada as EnderecoInterface)}
                                </div>
